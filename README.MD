...
> **Personal note:** I forked this for studying DNS tunneling techniques. The comparison table below is particularly useful for understanding the tradeoffs between different approaches.
